...
public class AssetLoader {
	...
	public static void load() {
		...
		logoDown = new TextureRegion(texture1, 49, 225, 237, 253);
		logoDown.flip(false, true);
		logo = new TextureRegion(texture1, 49, 225, 237, 253);
		logo.flip(false, true);
		logoUp = new TextureRegion(texture1, 49, 225, 237, 253);
		...
		kick = Gdx.audio.newSound(Gdx.files.internal("data/kick.wav"));
